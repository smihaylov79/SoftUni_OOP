...
class Storage:
    ...
    def get_document(self, document_id):
        return self.__get_obj(document_id, self.documents)



    def __edit_object(self, uid, collection, *args):
        obj = self.__get_obj(uid, collection)
        if obj:
            obj.edit(*args)

    def __delete_object(self, uid, collection):
        obj = self.__get_obj(uid, collection)
        if obj:
            collection.remove(obj)
    @staticmethod
    def __get_obj(object, collection):
