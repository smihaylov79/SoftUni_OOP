...
class Television(EntertainmentDevice, RCAConnector, HDMIConnector):
...
class DVDPlayer(EntertainmentDevice, HDMIConnector):
...
class GameConsole(EntertainmentDevice, HDMIConnector, EthernetConnector):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
...
class Router(EntertainmentDevice, EthernetConnector):
    def connect_to_tv(self, television):
